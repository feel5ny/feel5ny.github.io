...
date: '2018-03-11'
description: >-
  > 개인의 경험을 바탕으로 적은 글이기에 피드백은 언제나 댓글로 환영합니다. :) --- 목차 1.  모듈 세팅      프리티어
  설치하기        에디터에만 세팅하기        프로젝트에 세팅하기      프리티어 옵션 값 2.  precommit, 커밋 전
  옵...
author: Joy Kim
tags:
  - angular
...
<img src="/images/2018/08/05.png" align="right" width="250px" style={{marginLeft: '10px'}} />
...
<img src="/images/2018/08/01.png" width="250px" align="left" style={{marginBottom: '10px'}} />
