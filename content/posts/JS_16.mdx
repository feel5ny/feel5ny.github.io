...
date: '2018-08-25'
description: "> \U0001F4D2 인사이드 자바스크립트 중 메모해야할 부분만 적었습니다. --- 4. 함수 호출과 this - 함수호출시 암묵적으로 arguments 객체와 this인자가 전달된다. 4.1 arguments 객체 - 유사배열 객체 - 정의된 함수의 인자보다 적게 함수를 호출할..."
author: Joy Kim
tags:
  - javaScript
categories:
...
# 4. 함수 호출과 this - 함수호출시 암묵적으로 arguments 객체와 this인자가 전달된다.
