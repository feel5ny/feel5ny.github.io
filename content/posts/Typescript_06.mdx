...
description: >-
  ...
  있다면 언제든지 댓글 부탁드립니다. TL;DR inteface에 대해서 배웁니다. interface 내부에서 타입선언
  후 변수에서 사용하며, 함수에서는 implement...
author: Joy Kim
tags:
  - typeScript
categories:
...
### <a name="2" ></a> 2. interface optional property
...
#### <a name="2-2" ></a> 2-2. indexable type
...
### <a name="3" ></a> 3. function in interface
...
### <a name="4" ></a> 4. implements interface &#128580;
...
### <a name="5" ></a> 5. extends interface
...
### <a name="6" ></a> 6. function interface
