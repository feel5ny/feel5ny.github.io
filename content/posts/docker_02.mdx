...
date: '2022-02-21'
description: >-
  왜 우린 도커를 써야하나요? > 1. 지속가능한 데이터를 활용하기 위해 볼륨을 사용할 수 있으며,
  호스트볼륨을 공유하거나, 볼륨컨테이터를 만들어 활용하거나, 도커 볼륨을 활용할 수 있다.  > 2.
  도커는 컨테이너 내부IP를 순차적으로 할당하며,(컨테이너 별로 내부망이...
author: Joy Kim
tags:
  - docker
  - docker_volume
