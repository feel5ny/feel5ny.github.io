...
categories:
  ...
  - 02. HTTP
enableComment: true
customList: "[\n  {\n    \"title\": {\n      \"name\": \"쿠키 \U0001F36A\",\n      \"id\": \"cookie\"\n    }\n  },\n  {\n    \"hr\": {\n      \"type\": \"start\",\n      \"name\": \"쿠키에 대하여\"\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(종류) 쿠키의 타입 \U0001F481‍♀️\",\n      \"sub\": \"세션, 지속, Secure, Http-only, Same-site, Third-party, 좀비\",\n      \"id\": \"type\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"1\"\n      }\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(How) 쿠키는 어떻게 동작하는가 \U0001F9D0\",\n      \"sub\": \"Cookie헤더, Set-Cookie헤더\",\n      \"id\": \"how\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"2\"\n      }\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(State) 쿠키 상태 관리 ⏳\",\n      \"sub\": \"HTTP 상태 관리체계, Domain, Path\",\n      \"id\": \"state\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"3\"\n      }\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(Detail) 쿠키 구성요소 \U0001F9E9\",\n      \"sub\": \"Version0/Version1, RFC 6265\",\n      \"id\": \"detail\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"4\"\n      }\n    }\n  },\n  {\n    \"hr\": {\n      \"type\": \"start\",\n      \"name\": \"쿠키 사용 \"\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(When) 쿠키 목적별 사용 \U0001F440\",\n      \"sub\": \"Session 추적\",\n      \"id\": \"when\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"1\"\n      }\n    }\n  },\n  {\n    \"title\": {\n      \"name\": \"(Be Careful) 쿠키 사용시 주의사항 \U0001F46E‍\",\n      \"sub\": \"캐시, 보안 및 개인정보\",\n      \"id\": \"careful\",\n      \"style\": {\n        \"type\": \"number\",\n        \"index\": \"2\"\n      }\n    }\n  }\n]"
