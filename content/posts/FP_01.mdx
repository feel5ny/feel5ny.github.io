...
date: '2018-11-05'
description:
  "> \U0001F4D2 인사이드 자바스크립트 중 메모해야할 부분만 적었습니다. > 함수형 프로그래밍에 대해서
  더 깊게 배우길 원한다면 Lisp나 Haskell과 같은 언어를 공부하자. TL;DR - Higher-Order Functions
  (고계 함수, 계산의 효율성) - Purit..."
author: Joy Kim
tags:
  - javaScript
...
customList:
  ...
  \"2\"\n    },\n    \"depth1\": [\n      {\n        \"name\": \"2.1 배열의 각 원소 총합
  구하기(reduce)\",\n        \"id\": \"2-1\"\n      },\n      {\n        \"name\": \"2.2
  팩토리얼\",\n        \"id\": \"2-2\"\n      },\n      {\n        \"name\": \"2.3 피보나치
  수열\",\n        \"id\": \"2-3\"\n      }\n    ]\n  },\n  {\n    \"title\": {\n      \"name\":
  \"3. 자바스크립트에서의 함수형 프로그래밍을 활용한 주요 함수\",\n      \"id\":
  \"3\"\n    },\n    \"depth1\": [\n      {\n        \"name\": \"3.1 함수
  적용(Function.prototype.apply)\",\n        \"id\": \"3-1\"\n      },\n      {\n        \"name\":
  \"cf__함수호출(괄호연산자 vs call/apply)\",\n        \"id\":
  \"cf__3\"\n      },\n      {\n        \"name\": \"3.2 커링\",\n        \"id\":
  \"3-2\"\n      },\n      {\n        \"name\": \"cf__slice 메서드\",\n        \"id\":
  \"cf__4\"\n      },\n      {\n        \"name\": \"3.3 bind\",\n        \"id\":
