...
description: >-
  ...
  있다면 언제든지 댓글 부탁드립니다. 요약 제네릭은 어떠한 클래스 혹은 함수에서 사용할 타입을 그
  함수나 클래스를 사용할 때 결정하는 프로그래밍 기법을 말한다. 정적 타입...
author: Joy Kim
tags:
  - typeScript
categories:
...
customList: |-
  [
    ...
    {
      "title": {
        "name": "2. basic generic",
        "id": "2"
      }
    },
    {
      "title": {
        "name": "3. Generic Array",
        "id": "3"
      }
    },
    {
      "title": {
        "name": "4. Generic Types",
        "id": "4"
      }
    },
    {
      "title": {
        "name": "5. Generic Class",
        "id": "5"
      }
    },
    {
      "title": {
        "name": "6. Generic with extends",
        "id": "6"
      }
    },
    {
      "title": {
        "name": "7. Generic with multiple types",
        "id": "7"
      }
    },
    {
      "title": {
        "name": "8. type lookup system",
        "id": "8"
      }
    }
  ]
...
### <a name="6" ></a> 6. Generic with extends
...
### <a name="7" ></a> 7. Generic with multiple types
...
### <a name="8" ></a> 8. type lookup system
