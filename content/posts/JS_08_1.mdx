...
## <a name="node" ></a> <span style={{color: '#1a2980'}}>1. Node 타입</span>
...
## <a name="document" ></a> <span style={{color: '#1a2980'}}>2. Document 타입</span>
...
## <a name="element" ></a> <span style={{color: '#1a2980'}}>3. Element 타입</span>
