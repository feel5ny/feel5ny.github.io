...
date: '2019-01-23'
description:
  "\U0001F315\U0001F311\U0001F311 > 코드스피츠 강의 정리록 --- 1. 왜 이렇게 짰니. - 개발 기본을
  알아보자. 철학/가치/동기 철학 - 상대주의적으로 바라보자. 기준 (: 왜 이렇게 짰니?.. 이것만 지켜도
  비용절감.) 1. 가치   : 이러이러한 가치를 추구했기 때문에 이렇게 작성..."
author: Joy Kim
tags:
  - javaScript
  - programming
...
customList: |-
  [
    {
      "title": {
        "name": "1. 왜 이렇게 짰니. (개발 기본)",
        "id": "1"
      }
    },
    {
      "title": {
        "name": "2. program과 timing",
        "id": "2"
      }
    },
    {
      "title": {
        "name": "3. 메모리, 주소값, 포인터, 변수, 디스펫치",
        "id": "3"
      }
    },
    {
