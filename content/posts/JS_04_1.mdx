...
## <a name="Function" ></a> 1. Function 타입
...
## <a name="declarations_expressions" ></a> 2. 함수 선언 vs 함수 표현식
...
## <a name="First_class_object" ></a> 3. 값처럼 쓰는 함수 (일급객체)
...
<div style="background-color: #303337; padding: 21px;">
