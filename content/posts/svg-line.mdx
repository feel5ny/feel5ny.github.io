...
date: '2021-06-28'
description: >-
  Progress bar를 구현해야한다.  웹에서 찾을 수 있는 여러 예제들을 참고하여 사용해도 되지만, 커스텀하기 어려운 경우 직접 구현을
  해야한다. 바로 생각나는 엣지 케이스는 무엇일까 ? Rounded progress bar의 코너 부분 채워지는 bar의 Corne...
author: Joy Kim
tags:
  - svg
  - rounded rect
...
<figure>
  ...
  <figcaption>채워질 때 마지막 코너 부분</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>다른 위치의 그라데이션</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>같은 위치의 그라데이션</figcaption>
</figure>
...
<iframe
  ...
  style={{width: '100%', height: '300px', border: '0', borderRadius: '8px', overflow: 'hidden'}}
