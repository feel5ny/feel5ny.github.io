...
date: '2019-02-04'
description: >-
  Comment Symbol에 대해서 이해가 안갔는데 C언어의 enum과 비슷한 개념이라고 설명한 부분에서 살짝 감이
  왔다.  ---- > ECMAScript6 책 (두고두고 보는 자바스크립트 표준 레퍼런스) > 인프런 JavaScript ES6+
  제대로 알아보기 – 중...
author: Joy Kim
tags:
  - javaScript
...
customList: |-
  [
    ...
    {
      "title": {
        "name": "4. Symbol 오브젝트 생성",
        "id": "4"
      }
    },
    {
      "title": {
        "name": "5. 오브젝트에서 Symbol 사용",
        "id": "5"
      }
    },
    {
